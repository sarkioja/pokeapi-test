...
export class InitialSchema1777746303283 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_2b528aae0bc3881d44c884a761" ON "teams" ("trainer_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_trainers_email_active" ON "trainers" ("email") WHERE deleted_at IS NULL`,
    );
    await queryRunner.query(
      `CREATE TABLE "pokemon_types" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type_name" character varying(50) NOT NULL, "damage_relations" jsonb NOT NULL, "fetched_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_4d2d359062d5345ac2aa14bd702" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_bf70e70ec07565a2bfe9160901" ON "pokemon_types" ("type_name") `,
    );
    await queryRunner.query(
      `ALTER TABLE "team_pokemon" ADD CONSTRAINT "FK_d57c055ab195ba614ccc4a1658e" FOREIGN KEY ("team_id") REFERENCES "teams"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "team_pokemon" ADD CONSTRAINT "FK_f816a20fa75d6093c265e49b836" FOREIGN KEY ("pokemon_id") REFERENCES "pokemon"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "teams" ADD CONSTRAINT "FK_2b528aae0bc3881d44c884a7618" FOREIGN KEY ("trainer_id") REFERENCES "trainers"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "team_pokemon" DROP CONSTRAINT "FK_f816a20fa75d6093c265e49b836"`,
    );
    await queryRunner.query(
      `ALTER TABLE "team_pokemon" DROP CONSTRAINT "FK_d57c055ab195ba614ccc4a1658e"`,
    );
